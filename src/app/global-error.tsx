...
export default function GlobalError({
  ...
  return (
    <html lang="vi">
      <body className="min-h-screen flex flex-col items-center justify-center font-sans bg-[#F8FAFC] text-slate-800 p-4">
        <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-xl text-center max-w-md w-full">
          ...
          <h2 className="text-lg font-bold text-slate-900 mb-2">Hệ thống gặp sự cố</h2>
          <p className="text-xs text-slate-600 mb-4 leading-relaxed">
            Đã có sự cố nghiêm trọng trong quá trình tải giao diện. Vui lòng bấm thử lại hoặc tải lại trang.
          </p>
          {error?.digest && (
