  ...
  return (
    <div style={{ background: C.bg, minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", color: C.text, fontFamily: "var(--font-body)" }}>
      <div style={{ background: C.panel, padding: 40, borderRadius: 8, width: 400, border: `1px solid ${C.border}`, textAlign: "center" }}>
        ...
        <p style={{ color: C.textMuted, fontSize: 14, marginBottom: 30 }}>Đăng nhập bằng tài khoản và mật khẩu nội bộ.</p>
        
        {errorMsg && (
          <div className="mb-4 p-2 text-sm rounded" style={{ background: C.redDim, color: C.red, border: `1px solid ${C.red}55` }}>
            {errorMsg}
          </div>
        )}
        ...
        <form onSubmit={handleLogin} className="text-left">
          <div className="mb-4">
            ...
            <TextInput id="email" type="email" required placeholder="vidu@gmail.com" />
          </div>
          <div className="mb-6">
            <FieldLabel>Mật khẩu (hoặc số điện thoại)</FieldLabel>
            <TextInput id="password" type="password" required placeholder="Nhập mật khẩu..." />
          </div>
          <Btn tone="primary" type="submit" loading={loading} className="w-full justify-center">
            Đăng nhập
          </Btn>
        </form>
      </div>
